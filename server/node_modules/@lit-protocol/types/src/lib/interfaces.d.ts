...
export declare type CustomNetwork = Pick<LitNodeClientConfig, 'litNetwork' | 'bootstrapUrls' | 'contractContext' | 'checkNodeAttestation'> & Partial<Pick<LitNodeClientConfig, 'minNodeCount'>>;
/**
 ...
 */
export declare type SessionSigsMap = Record<string, SessionSig>;
...
export declare type SessionSigs = Record<string, SessionSig>;
...
export declare type PKPEthersWalletProp = PKPBaseProp;
