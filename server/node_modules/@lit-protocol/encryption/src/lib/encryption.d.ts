...
import { DecryptRequest, DecryptZipFileWithMetadata, DecryptZipFileWithMetadataProps, EncryptFileAndZipWithMetadataProps, EncryptFileRequest, EncryptRequestBase, EncryptResponse, EncryptStringRequest, EncryptZipRequest, IJWT, ILitNodeClient, SigningAccessControlConditionJWTPayload, VerifyJWTProps, EncryptToJsonProps, DecryptFromJsonProps } from '@lit-protocol/types';
/**
...
*/
export declare const zipAndEncryptFiles: (files: File[], paramsBase: EncryptRequestBase, litNodeClient: ILitNodeClient) => Promise<EncryptResponse>;
/**
 *
