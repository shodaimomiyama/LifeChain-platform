...
class LitContracts {
  ...
  // ***********************************************************************************************
        ...
        this.mintWithAuth = async ({ authMethod, scopes, pubkey, }) => {
            // -- validate
            if (!this.connected) {
...
https://developer.litprotocol.com/v3/sdk/wallets/auth-methods/#auth-method-scopes
      `);
            ...
            const authId = await (0, auth_utils_1.getAuthIdByAuthMethod)(authMethod);
            // -- go
            ...
            [authMethod.authMethodType], [authId], [_pubkey], [[...scopes]], true, true, {
                value: mintCost,
            });
    ...
    static async getStakingContract(network, context) {
        let provider;
...
LitContracts.getMinNodeCount = async (network, context) => {
...
LitContracts.getValidators = async (network, context) => {
    const contract = await LitContracts.getStakingContract(network, context);
    // Fetch contract data
